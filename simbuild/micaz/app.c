...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b84458, const void *arg_0xb7b845f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b358c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79df840), 
int (*key_eq_fn)(void *arg_0xb79dfc88, void *arg_0xb79dfe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78ae9b8, int arg_0xb78aeb10);
static double RandomUniform(void );
...
typedef TMilli /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef uint16_t /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
am_addr_t sendAckC$sender_addr[1000];
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 18 "FakeSensorP.nc"
static inline error_t /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 18
{
  /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}
...
#line 55
  __nesc_result = /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
#line 164
  sim_log_debug(159U, "radio_rec", "Received message\n");
  if (len != sizeof(my_msg_t )) {
#line 165
    return buf;
    }
  sim_log_debug(160U, "radio_rec", "Received message and got through:\n\tType: %hu, \n\tCounter: %hu, \n\tValue: %hu\n", __nesc_ntoh_uint8(message_received->msg_type.nxdata), __nesc_ntoh_uint16(message_received->msg_counter.nxdata), __nesc_ntoh_uint16(message_received->value.nxdata));


  if (TOS_NODE_ID == 2) {

      sendAckC$counter[sim_node()] = __nesc_ntoh_uint16(message_received->msg_counter.nxdata);
      sendAckC$sender_addr[sim_node()] = sendAckC$AMPacket$source(buf);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb764f298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb764f298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb764f298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb764f930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb764f930, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(151U, "radio", "Radio on!\n");
      if (TOS_NODE_ID == 1) {
...
#line 100
{
  ...
  sim_log_debug(152U, "split-control", "Application stopped\n");
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb765e8b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb765e8b0, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74f2010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74f2010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74f2010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb780a650){
#line 75
  switch (arg_0xb780a650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb780a650);
#line 75
      break;
#line 75
    }
...
#line 62
  ...
  __nesc_hton_uint16(message->value.nxdata, 0);

  if (sendAckC$Ack$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      sim_log_debug(148U, "radio_ack", "Ack message is enabled. Sending message...\n");
    }
  else 
#line 71
    {
      sim_log_error(149U, "radio_ack", "Acks DISABLED\n");
    }
...
#line 106
{
  ...
  sim_log_debug(153U, "timer", "Timer fired at %s.", sim_time_string());
  sim_log_debug(154U, "timer", " Counter is %hu.\n", sendAckC$counter[sim_node()]);
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 182
{
  ...
  if (!sendAckC$locked[sim_node()] && result == SUCCESS) {
      ...
      __nesc_hton_uint8(message->msg_type.nxdata, 2);
      __nesc_hton_uint16(message->msg_counter.nxdata, sendAckC$counter[sim_node()]);
      __nesc_hton_uint16(message->value.nxdata, data);
      if (sendAckC$Ack$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
          sim_log_debug(161U, "radio_ack", "Acks enabled\n");
        }
      if (sendAckC$AMSend$send(sendAckC$sender_addr[sim_node()], &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sendAckC$locked[sim_node()] = TRUE;
        }
    }
}
...
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
...
#line 24
{
  /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Random$rand16());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb7374c70){
#line 83
  switch (arg_0xb7374c70) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 1U:
#line 83
      /*sendAckAppC.sensor.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb7374c70);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74f29f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74f29f8, addr, msg, len);
#line 80
...
#line 134
      sim_log_debug(155U, "radio_send", "Sent message with counter: %hu\n", sendAckC$counter[sim_node()]);
      sendAckC$locked[sim_node()] = FALSE;

      if (sendAckC$Ack$wasAcked(buf) && TOS_NODE_ID == 1) {
          sendAckC$MilliTimer$stop();
          sim_log_debug(156U, "radio_ack", "Ack received.\n");
        }
      else {
#line 141
        if (sendAckC$Ack$wasAcked(buf) && TOS_NODE_ID == 2) {
            sim_log_debug(157U, "radio_ack", "Ack received.\n");
            sendAckC$SplitControl$stop();
          }
        else {
            sim_log_debug(158U, "radio_ack", "Ack not received\n");
          }
        }
#line 148
      sendAckC$counter[sim_node()]++;
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$sender_addr"))
  {
    *addr = (uintptr_t)&sendAckC$sender_addr[__nesc_mote];
    *size = sizeof(sendAckC$sender_addr[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&sendAckC$sender_addr[__nesc_mote], 0, sizeof sendAckC$sender_addr[__nesc_mote]);
